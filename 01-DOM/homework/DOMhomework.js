...
// Tu código acá:
let nameApp = document.getElementById ('createdBy')
nameApp.innerHTML = nameApp.innerHTML + ' Felipe'
...
//  toDoText.id = index;
  if (todo.complete) box.checked = true
...
function buildToDos(toDos) {
  // Tu código acá:
  const newArray = toDos.map (buildToDo)
  return newArray
}
